...
from tensorflow.python.ops.rnn_field_cell import DNNField, BasicFieldCell, DNNKernelField, KernelFieldCell
...
class PTBModel(object):
  ...
  def __init__(self, is_training, config, input_):
    ...
    # fields = DNNField(size,size,hidden_units=[5]).dnn_fieldA
    # fields = DNNField(size,size,hidden_units=[50]).dnn_field2A  # [size,50], 1e-1 lr, no tanh on outputs (before softmax)
