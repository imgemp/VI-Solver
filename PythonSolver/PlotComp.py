...
ax1[0].errorbar(RKHEIter[:,0],  RKHEIterAVG,  fmt='g:', yerr=RKHEIterSEM,  ecolor='g', lw=2, label='RKHE Iters');
ax1[0].errorbar(RKCKIter[:,0],  RKCKIterAVG,  fmt='r--', yerr=RKCKIterSEM,  ecolor='r', lw=2, label='RKCK Iters');
...
ax1[1].errorbar(RKHETime[:,0],  RKHETimeAVG,  fmt='g:', yerr=RKHETimeSEM,  ecolor='g', lw=2, label='RKHE Time');
ax1[1].errorbar(RKCKTime[:,0],  RKCKTimeAVG,  fmt='r--', yerr=RKCKTimeSEM,  ecolor='r', lw=2, label='RKCK Time');
