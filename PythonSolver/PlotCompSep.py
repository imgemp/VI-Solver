...
ax1.errorbar(EulerIter[0:2,0], EulerIterAVG[0:2], fmt='b-',  yerr=EulerIterSEM[0:2], ecolor='b', lw=lw, label='Euler Iters');
...
ax1.errorbar(EGIter[0:2,0], EGIterAVG[0:2], fmt='k-.',  yerr=EGIterSEM[0:2], ecolor='k', lw=lw, label='EG Iters');
#ax1.plot([EGIter[0,0],EGIter[1,0],RKHEIter[-1,0]], [EGIterAVG[0],10.**6,10.**6], 'k-.', lw=2);
ax1.errorbar(RKHEIter[:,0],  RKHEIterAVG,  fmt='g:',  yerr=RKHEIterSEM, ecolor='g', lw=lw, label='RKHE Iters');
ax1.errorbar(RKCKIter[:,0],  RKCKIterAVG,  fmt='r--', yerr=RKCKIterSEM, ecolor='r', lw=lw, label='RKCK Iters');
ax1.errorbar(ABIter[:,0],    ABIterAVG,    fmt='c-.', yerr=ABIterSEM,   ecolor='c', lw=lw, label='AB Iters');
ax1.set_xscale('log');
ax1.set_yscale('log');
...
ax2.errorbar(EulerTime[0:2,0], EulerTimeAVG[0:2], fmt='b-',  yerr=EulerTimeSEM[0:2], ecolor='b', lw=lw, label='Euler Time');
...
ax2.errorbar(EGTime[0:2,0], EGTimeAVG[0:2], fmt='k-.',  yerr=EGTimeSEM[0:2], ecolor='k', lw=lw, label='EG Iters');
#ax2.plot([EGTime[3,0],RKHETime[4,0],RKHETime[-1,0]], [EGTimeAVG[3],10.**4,10.**4], 'k-', lw=2);
ax2.errorbar(RKHETime[:,0],  RKHETimeAVG, fmt='g:',  yerr=RKHETimeSEM, ecolor='g', lw=lw, label='RKHE Time');
ax2.errorbar(RKCKTime[:,0],  RKCKTimeAVG, fmt='r--', yerr=RKCKTimeSEM, ecolor='r', lw=lw, label='RKCK Time');
ax2.errorbar(ABTime[:,0],    ABTimeAVG,   fmt='c-.', yerr=ABTimeSEM,   ecolor='c', lw=lw, label='AB Time');
ax2.set_xscale('log');
ax2.set_yscale('log');
